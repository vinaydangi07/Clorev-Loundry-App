...
@Component({
  selector: 'app-rate-list-header',
  templateUrl: './rate-list-header.component.html',
  styleUrls: ['./rate-list-header.component.css']
})
export class RateListHeaderComponent implements OnInit {
