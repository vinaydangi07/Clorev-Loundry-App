...
@Component({
  selector: 'app-schedule-pickup-header',
  templateUrl: './schedule-pickup-header.component.html',
  styleUrls: ['./schedule-pickup-header.component.css']
})
export class SchedulePickupHeaderComponent implements OnInit {
