...
@Component({
  selector: 'app-order-summery-header',
  templateUrl: './order-summery-header.component.html',
  styleUrls: ['./order-summery-header.component.css']
})
export class OrderSummeryHeaderComponent implements OnInit {
  timePassed = 0;
  timeLeft = TIME_LIMIT;
  timerInterval: any;
  isTimerHidden = true;
